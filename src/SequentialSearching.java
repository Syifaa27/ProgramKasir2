...
public class SequentialSearching {
    public static void main(String[]args)throws IOException{
       ...
       System.out.println("\nPENGISISAN DATA");
       System.out.println("1.Di input oleh program--> Pilihan[1/2]:");
       int isi = Integer.parseInt(dataIn.readLine());
       switch(isi){
           case 1: // Pengisisan Data dilakukan oleh si User
               System.out.println();
               ...
               break;
           case 2: // Pengisisna Data dilakukan oleh program secara random
               for(int a=0; a<jlh_data;a++){
                   data[a]=new Random().nextInt(201); // Data di isi secara random dengn nilai tertinggi 200}
               }
                   // Tampilkan Ddata yang di isi oleh program
                   System.out.println("\nTampilkan Data");
                   for(int a=0; a<jlh_data;a++){
                   ...
                   boolean temu=false; //Variabel indikator,jika data sudah ditemukan
                   int urutan=0;  // Variabel untuk mengetahui urutan ke berapa data yang dicari
                   for(int a=0;a<jlh_data;a++){
